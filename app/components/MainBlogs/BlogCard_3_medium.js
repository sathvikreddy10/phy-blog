...
export default function BlogCard_3_medium({ data }) {
  ...
  return (
    ...
    <Link 
        href={`/blog/${data?.id}`}
        className="BlogCard_medium border border-[#c3c3c3bc] rounded-[1.5rem] w-[22.95rem] h-[22.5rem] flex flex-col px-6 py-2 relative overflow-hidden items-center hover:shadow-lg transition-shadow duration-300"
    >
              
      
              <div className="image_container w-full h-[38.80%] rounded-lg relative overflow-hidden mt-[0.35rem]">
               <Image 
                    src={getCoverImage()} 
                    fill={true} 
                    alt="image" 
            ...
            <div className="letters flex flex-col justify-between w-full flex-1 ">
             ...
             <div className="heading_and_author pr-0.5 w-full">
              <div className="blog_heading font-heading font-semibold text-[1.65rem] mt-5 ml-1 truncate text-black">
                {data?.title || "Untitled"}
              </div>
      
              <div className="author_name font-body font-medium text-xs text-[#a7a4a4] flex items-center justify-end ">
            ...
            <div className="excr_extras flex flex-col gap-0.5">
              <div className="blog_expricit font-body font-normal leading-tight line-clamp-4 text-black">
                {getExcerpt()}
              </div>
      
              <div className="extras mt-auto w-full flex items-center justify-between pt-3 pb-0.5 border-t border-transparent">
